...
export function AceptarInvitacionBtn({
  ...
  const handleRechazar = () => {
    startRechazar(async () => {
      await rechazarInvitacion(tokenId)
    ...
    return (
      <div className="space-y-3">
        <div className="bg-red-50 border border-red-200 rounded-xl p-4">
          ...
          <p className="text-xs text-red-600">No te vincularás a {distriNombre}. Podés pedir otro link si cambiás de opinión.</p>
        </div>
    ...
    <div className="space-y-4">
      ...
      <label className="flex items-start gap-3 cursor-pointer select-none">
        ...
        <p className="text-xs text-gray-500 leading-relaxed">
          Acepto los términos y condiciones de uso de GondolApp y autorizo el intercambio de información con {distriNombre}.
        </p>
      </label>
      ...
      >
        {isPendingAceptar ? <Loader2 size={18} className="animate-spin" /> : `🤝 Sí, unirme a ${distriNombre}`}
      </button>
      <button
