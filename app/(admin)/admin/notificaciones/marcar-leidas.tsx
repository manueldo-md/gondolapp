 ...
 *
 * Hasta el 25/9/2026 este archivo exportaba `MarcarAdminLeidas`, que no
 ...
 * y la bandeja del equipo es la que menos se puede permitir perder el rastro.
 *
...
export function MarcarTodasLeidas() {
  ...
  return (
    <button
      onClick={() => empezar(async () => { await marcarNotificacionesAdminLeidas() })}
      disabled={pendiente}
