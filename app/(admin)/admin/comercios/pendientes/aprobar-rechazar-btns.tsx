  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        description={`Vas a rechazar ${nombreComercio ? `"${nombreComercio}"` : 'este comercio'}. Las fotos pendientes perderán sus puntos retenidos. Esta acción no se puede deshacer.`}
        confirmLabel="Rechazar comercio"
        onConfirm={() => startTransition(async () => {
          await rechazarComercio(comercioId)
          setEstado('rechazado')
