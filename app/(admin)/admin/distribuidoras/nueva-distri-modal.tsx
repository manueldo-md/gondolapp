...
import { crearDistribuidora } from './actions'

export function NuevaDistriModal() {
  ...
  const handleSubmit = () => {
    ...
    startTransition(async () => {
      const result = await crearDistribuidora({ razon_social: razonSocial.trim(), cuit: cuit.trim() || null })
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-5">
              <h3 className="font-bold text-gray-900 text-base">Nueva distribuidora</h3>
            ...
            <div className="flex gap-3 mt-5">
              ...
              >
                {isPending ? <Loader2 size={15} className="animate-spin" /> : 'Crear distribuidora'}
              </button>
            </div>
          </div>
        </div>
