...
export function InvitacionAcciones({ token }: { token: string }) {
  ...
  if (resultado === 'aceptada') {
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
        ...
        <p className="text-sm text-green-700">La campaña ya está activa. Podés verla en tu panel de distribuidora.</p>
      </div>
    )
  }
