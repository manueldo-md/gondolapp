    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 mb-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
          ...
          {(c.tope_total_comercios ?? c.minimo_comercios) && (
            <div className="flex items-start gap-2">
              <Target size={14} className="text-gray-400 mt-0.5 shrink-0" />
              <div><p className="text-xs text-gray-400">Tope global</p><p className="font-medium text-gray-900">{c.tope_total_comercios ?? c.minimo_comercios} comercios</p></div>
            </div>
          )}
          <div className="flex items-start gap-2">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-5">
          ...
          <div className="flex flex-wrap gap-2">
            {zonasActuales.map((zona, i) => (
              <span key={i} className="text-xs px-2.5 py-1 bg-gondo-amber-50 text-gondo-amber-400 rounded-full font-medium border border-gondo-amber-100">
                {zona}
              </span>
            ))}
          </div>
