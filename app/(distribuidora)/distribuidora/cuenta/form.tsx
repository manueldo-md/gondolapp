...
import { actualizarCuentaDistri } from './actions'
...
export function CuentaDistriForm({ email, nombre: nombreInicial, celular: celularInicial, razonSocial, cuit }: Props) {
  ...
  const handleGuardarPerfil = async (e: React.FormEvent) => {
    ...
    await actualizarCuentaDistri({ nombre, celular })
  ...
  const inputClass = 'w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gondo-amber-400 text-sm'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h2 className="text-sm font-semibold text-gray-700 mb-4">Datos de la empresa</h2>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleGuardarPerfil} className="space-y-4">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-gondo-amber-400 hover:bg-gondo-amber-500 text-white text-sm font-semibold rounded-lg disabled:opacity-50 transition-colors"
          >
