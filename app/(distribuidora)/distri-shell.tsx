...
import { Images, Users, Store, Megaphone, LogOut, UserCog, LayoutDashboard, Bell, Tag, Wrench, Package, TrendingUp, MapIcon } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/distribuidora/panel',           label: 'Metricas',             icon: TrendingUp      },
  { href: '/distribuidora/mapa',            label: 'Mapa',                 icon: MapIcon         },
  ...
  { href: '/distribuidora/repositoras',     label: 'Repositoras',          icon: Package         },
      ...
      <div className="ml-60 flex-1 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-10 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0">
          ...
          <NotifBell
            ...
            href="/distribuidora/notificaciones"
            actorId={distriId}
