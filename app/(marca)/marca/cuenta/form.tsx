...
import { actualizarCuentaMarca } from './actions'
...
export function CuentaMarcaForm({ email, nombre: nombreInicial, celular: celularInicial, razonSocial, cuit }: Props) {
  ...
  const handleGuardarPerfil = async (e: React.FormEvent) => {
    ...
    await actualizarCuentaMarca({ nombre, celular })
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleGuardarPerfil} className="space-y-4">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-gondo-indigo-600 hover:bg-gondo-indigo-700 text-white text-sm font-semibold rounded-lg disabled:opacity-50 transition-colors"
          >
