 ...
 *
 * Hasta el 25/9/2026 este archivo exportaba `MarcarMarcaLeidas`, que no
 ...
 * y la marca es justamente la que necesita saber qué no miró.
 *
...
export function MarcarTodasLeidas() {
  ...
  return (
    <button
      onClick={() => empezar(async () => { await marcarNotificacionesMarcaLeidas() })}
      disabled={pendiente}
