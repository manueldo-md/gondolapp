...
import { Map as MapIcon, LayoutDashboard, Megaphone, Images, LogOut, Coins, UserCog, Building2, Bell, Package } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/marca/mapa',             label: 'Mapa',             icon: MapIcon         },
