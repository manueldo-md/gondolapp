> # ⚠️ DOCUMENTO HISTÓRICO — NO ES LA FUENTE DE VERDAD
>
> **Describe la base ANTERIOR al `DROP SCHEMA public CASCADE` del 7/9/2026.**
> Esa base ya no existe: producción se reconstruyó ese mismo día desde las 57
> migraciones del repo.
>
> Se conserva solo como registro de lo que había antes del incidente, y porque
> fue el insumo con el que se reconciliaron las migraciones: los grupos A, B y
> C del análisis salieron de comparar contra este documento.
>
> **La fuente de verdad actual es `docs/schema-real-2026-09.md`**, regenerado
> desde producción el 7/9/2026 después de la reconstrucción.
>
> Casi todas las diferencias que este documento marca contra el schema actual
> son objetos que ya no existen en ningún lado, no divergencias por resolver.
